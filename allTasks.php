<?php
	...
	$sqlString = "SELECT tasks.task_ID, tasks.task_name, settings.category, tasks.task_category, tasks.task_duedate, tasks.task_comments, settings.category_color FROM tasks INNER JOIN settings ON task_category=settings.category_ID  WHERE tasks.user_ID = $currentUser ORDER BY tasks.task_duedate";
	...
	while ($row = $statement->fetch(PDO::FETCH_ASSOC))
	{
		...
		$returnStatement = $returnStatement . "<td style=\"width: 20%\" id=\"" . $categoryID . "\">" . $category . "</td>";
