<?php
    ...
    try
    {
		...
		$sqlString = "UPDATE pending SET task_name = \"$taskName\", task_category = \"$taskCategory\", task_duedate = \"$fullDueDate\", task_comments = \"$taskComments\" WHERE task_ID = $currentTask";
